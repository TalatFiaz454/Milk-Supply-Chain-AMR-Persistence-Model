...
class BiofilmPersistenceABM(Model):
    ...
    def __init__(
            ...
            n_surfaces=10,
            colonization_prob=0.05,
            colonization_mass=0.25,
            biofilm_growth_rate=0.02,
            shedding_prob=0.2,
            shedding_fraction=0.1,
            cleaning_interval=7,
            cleaning_efficiency=1.0,
            cleaning_strength=0.95,
            seed=None,

            # NEW VALIDATION SWITCHES
            disable_colonization=False,
            disable_growth=False,
        ...
        if disable_colonization:
            colonization_prob = 0.0

        if disable_growth:
            biofilm_growth_rate = 0.0
    ...
    def set_upstream_distribution(self, new_dist):
        self.upstream_amr_distribution = new_dist
